        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-m">
          <form class="space-y-6" action="login.do" method="POST">
            ...
            <div>
              ...
              <div class="mt-2">
                <input id="password" name="password" type="password" autocomplete="current-password" required class="block w3-table-all rounded-md -border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
              </div>
            </div>
            &nbsp;
            <div>
              &nbsp;&nbsp;&nbsp &nbsp;&nbsp;&nbsp;&nbsp;&nbsp &nbsp;&nbsp;&nbsp;&nbsp;&nbsp
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../form.do" class="font-semibold text-indigo-600 hover:text-indigo-500">회원가입</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp &nbsp;&nbsp;&nbsp;&nbsp;&nbsp &nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
